# Prior Art Research — web-business-growth
...
- Stage lesson: 保留真实 GSC/GA 数据和 query/page 读取；落到原始 period 与指标.
...
- Stage lesson: 保留 opportunity-driven expansion；拒绝以模板能力自动放量.
